...
async def get_active_plan(product_code: str, include_hierarchy: bool, internal_identifier: Optional[str] = Query(default=None), user_service: UserService = Depends()):
    return await user_service.get_active_plan(product_code, include_hierarchy, internal_identifier)